...
//FIXME: why - 10?
z_threaded_rod_length = z_smooth_rod_length - 10;
echo("x_smooth_rod_length", x_smooth_rod_length);
echo("y_smooth_rod_length", y_smooth_rod_length);
echo("z_smooth_rod_length", z_smooth_rod_length);
